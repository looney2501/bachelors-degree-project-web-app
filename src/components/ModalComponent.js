...
class ModalComponent extends React.Component {
  ...
  render() {
    return <>
      <div className={`modal fade ${this.props.className}`} id={this.props.id} tabIndex="-1"
           aria-labelledby={this.props.exampleModalLabel} data-bs-backdrop={this.props.dataBsBackdrop}
           aria-hidden={this.props.ariaHidden} style={{ display: 'none' }}>

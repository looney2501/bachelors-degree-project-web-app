  ...
  render() {
    return <div className="border-end sidenav" id="sidebar-wrapper">
      ...
      <div className="dropdown fixed-bottom-dropdown">
        {/*<a href="#" className="d-flex align-items-center text-decoration-none dropdown-toggle" id="dropdownUser2"*/}
        ...
        {/*  </li>*/}
        {/*  <li><Link className="dropdown-item" to="/login"><i className="fa fa-sign-out" aria-hidden="true"></i> Sign out</Link>*/}
        {/*  </li>*/}
        {/*</ul>*/}
        <Link className="" to="/login"><i className="fa fa-sign-out" aria-hidden="true"></i> Sign out</Link>

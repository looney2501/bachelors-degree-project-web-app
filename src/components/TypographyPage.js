    ...
    return (
      <>
              ...
              <tr>
                ...
                <td>
                  <div className="dropdown table-action-dropdown">
                    <button className="btn btn-secondary btn-sm dropdown-toggle" type="button" id="dropdownMenuButtonSM"
                            data-bs-toggle="dropdown" aria-expanded="false"><i className="fa fa-ellipsis-v"
                                                                               aria-hidden="true"></i></button>
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButtonSM">
                      <li><a className="dropdown-item" href="#"><i className="fa fa-pencil"
                                                                   aria-hidden="true"></i>&nbsp;Edit</a></li>
                      <div className="dropdown-divider"></div>
                      <li><a className="dropdown-item text-danger" href="#"><i className="fa fa-trash"
        ...
        <div className="my-3 p-3 bg-body rounded shadow-sm">
          ...
          {/* modals */}
          <ModalComponent title="Default Modal" footerContent={this.modalFooterContent()} content={this.modalContent()}
                          dataBsBackdrop="static" id="exampleModalDefault"/>
          {/* full screen */}
          <ModalComponent title="Full Screen Modal" footerContent={this.modalFooterContent()}
                          content={this.modalContent()} fullScreen="true" dataBsBackdrop="static"
                          id="fullScreenModalDefault"/>
          {/* right modal */}
          <ModalComponent title="Right Sidebar Modal" footerContent={this.modalFooterContent()}
                          content={this.modalContent()} className="right" dataBsBackdrop="static"
                          id="rightModalDefault"/>
          {/* left modal */}
          <ModalComponent title="Left Sidebar Modal" footerContent={this.modalFooterContent()}
                          content={this.modalContent()} className="left" dataBsBackdrop="static" id="leftModalDefault"/>
        </div>
        <div className="my-3 p-3 bg-body rounded shadow-sm">
          ...
          <div>
            <div className="bd-example">
              <div className="btn-group w-100 align-items-center justify-content-between flex-wrap">
                ...
                <div className="dropdown">
                  <button className="btn btn-secondary btn-lg dropdown-toggle" type="button" id="dropdownMenuButtonLG"
                          data-bs-toggle="dropdown" aria-expanded="false">
                    Dropdown button
                  </button>
            ...
            <div className="bd-example">
              <div className="btn-group w-100 align-items-center justify-content-between flex-wrap">
                <div className="dropend">
                  <button className="btn btn-secondary dropdown-toggle" type="button" id="dropendMenuButton"
                          data-bs-toggle="dropdown" aria-expanded="false">
                    Dropend button
                  </button>
                ...
                <div className="dropup">
                  <button className="btn btn-secondary dropdown-toggle" type="button" id="dropupMenuButton"
                          data-bs-toggle="dropdown" aria-expanded="false">
                    Dropup button
                  </button>
                ...
                <div className="dropstart">
                  <button className="btn btn-secondary dropdown-toggle" type="button" id="dropstartMenuButton"
                          data-bs-toggle="dropdown" aria-expanded="false">
                    Dropstart button
                  </button>
            ...
            <div className="bd-example">
              <div className="btn-group">
                <div className="dropdown">
                  <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownRightMenuButton"
                          data-bs-toggle="dropdown" aria-expanded="false">
                    End-aligned menu
                  </button>
          ...
          <div>
            <div className="bd-example">
              ...
              <div className="alert alert-primary alert-dismissible fade show" role="alert">
                A simple primary alert with <a href="#" className="alert-link">an example link</a>. Give it a click if
                you like.
              ...
              <div className="alert alert-success alert-dismissible fade show" role="alert">
                A simple success alert with <a href="#" className="alert-link">an example link</a>. Give it a click if
                you like.
                <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
              <div className="alert alert-danger alert-dismissible fade show" role="alert">
                A simple danger alert with <a href="#" className="alert-link">an example link</a>. Give it a click if
                you like.
                <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
              <div className="alert alert-warning alert-dismissible fade show" role="alert">
                A simple warning alert with <a href="#" className="alert-link">an example link</a>. Give it a click if
                you like.
                <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            ...
            <article className="my-3" id="disabled-forms">
              <div className="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                ...
                <a className="d-flex align-items-center"
                   href="/docs/5.1/forms/overview/#disabled-forms">Documentation</a>
              </div>
                  ...
                  <form>
                    <fieldset disabled="" aria-label="Disabled fieldset example">
                      ...
                      <fieldset className="mb-3">
                        ...
                        <div className="form-check">
                          <input type="radio" name="radios" className="form-check-input" id="disabledRadio1"
                                 disabled=""/>
                          <label className="form-check-label" htmlFor="disabledRadio1">Disabled radio</label>
                        </div>
                        <div className="mb-3 form-check">
                          <input type="radio" name="radios" className="form-check-input" id="disabledRadio2"
                                 disabled=""/>
                      ...
                      <div className="mb-3 form-check form-switch">
                        <input className="form-check-input" type="checkbox" role="switch"
                               id="disabledSwitchCheckChecked" disabled=""/>
                        <label className="form-check-label" htmlFor="disabledSwitchCheckChecked">Disabled checked switch

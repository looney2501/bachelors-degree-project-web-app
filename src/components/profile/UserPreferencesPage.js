          ...
          <div className="col">
            <div className="mb-3 form-check form-switch">
              ...
              <label className="form-check-label" htmlFor="disabledSwitchCheckChecked">
                <p>App updates <span className="text-gray-italic"> Receive notifications whenever we release a new update</span>
                </p>
              </label>
            </div>
            <div className="mb-3 form-check form-switch">
              <input className="form-check-input" type="checkbox" role="switch" id="disabledSwitchCheckChecked"/>
              <label className="form-check-label" htmlFor="disabledSwitchCheckChecked">
                <p>Task Assigned <span className="text-gray-italic"> Receive notifications whenever a new task is assigned to you </span>
                </p>
              </label>
            </div>
            <div className="mb-3 form-check form-switch">
              <input className="form-check-input" type="checkbox" role="switch" id="disabledSwitchCheckChecked"/>
              <label className="form-check-label" htmlFor="disabledSwitchCheckChecked">
                <p>Comments Added <span className="text-gray-italic"> Receive notifications whenever a comment is added to a document that you follow </span>
                </p>
              </label>
            </div>
            <div className="mb-3 form-check form-switch">
              <input className="form-check-input" type="checkbox" role="switch" id="disabledSwitchCheckChecked"/>
              <label className="form-check-label" htmlFor="disabledSwitchCheckChecked">
                <p>Document updated <span className="text-gray-italic"> Receive notifications whenever a document that you follow is edited. </span>
                </p>
              </label>
            </div>
            <hr/>
